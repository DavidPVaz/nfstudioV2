...
>(({ side = 'right', className, children, ...props }, ref) => (
    <SheetPortal>
        ...
        >
            {children}
            <div className="absolute left-[2rem] top-[1.25rem]">
                <NFStudioIcon className="h-[2.5rem] w-auto fill-primary-brand" />
            </div>

            <SheetPrimitive.Close className="absolute right-[2.5rem] top-[1.65rem] rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
