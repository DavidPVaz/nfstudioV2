        ...
        <div className="relative flex flex-col gap-y-4">
            {STEPS.map((step, index) => (
                <div key={index} className="relative flex flex-row items-center gap-x-3 sm:gap-x-6">
                    <div className="relative flex max-h-11 min-w-[52.69px] rounded-br-lg rounded-tr-lg bg-primary-brand pb-2 pl-6 pr-2 pt-2 sm:max-h-12 sm:min-w-[54.97px]">
